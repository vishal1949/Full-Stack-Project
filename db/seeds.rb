...
User.destroy_all
demo_user = User.create!({email:"demo@login", password: "password", first_name: "demo", last_name: "user"})
...
spot_one = Listing.create!({ owner_id: user_one[:id], title: "Beautiful apartment", address: "55 Chumasero Dr"
...
# spot_two = Listing.create({owner_id: 21, title: "Beautiful apartment with beautiful view", address: "80 Chumasero Dr"
#     , city: "San Francisco", state: "California", zip: 94312, num_rooms: 2, num_bathrooms: 2, available: true
#     , price: 100, description: "This one is the most amazing", private_room: true, house: false, washer: false, dryer: false
#     , parking_spot: false, tv: true, wifi: true, ac: false, kitchen: true})
# spot_three = Listing.create({owner_id: 21, title: "Beautiful apartment, no view", address: "60 Chumasero Dr"
#     , city: "San Francisco", state: "California", zip: 94312, num_rooms: 2, num_bathrooms: 2, available: true
